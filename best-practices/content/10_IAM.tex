...
\begin{minipage}{\linewidth}
    ...
    \end{multicols}
\end{minipage}
%TODO: @sevigrimm ergänzungen?
%TODO: Add glossary for DHCP DNS NTP CA
...
Active Directory ist mit mehr als 80\% Marktanteil der Marktführer. Die Active Directory Funktion wird mit \acrshort{dns}, \acrshort{dhcp} und \acrshort{ntp} gebündelt. Das Produkt bietet alle grundlegenden Funktionen wie User-, Geräteverwaltung, \acrshort{dhcp}, \acrshort{dns}, \acrshort{ntp} und viele weitere einfache, bis zu komplexe Funktionen. Vorallem in Windowsnetzwerken ist die Integration sehr gut und intuitiv.\\
