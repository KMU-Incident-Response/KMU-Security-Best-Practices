...
Für die persönliche Firewall wird der Windows Defender empfohlen.
Dieser wird automatisch von Windows verwaltet und darum wird es diesem Dokument nicht weiter behandelt.
...
Auch Whitelist Policy\footnote{https://de.wikipedia.org/wiki/Wei\%C3\%9Fe\_Liste} gennant.
